                    ...
                    <div class="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
                        ...
                        <div class="col-span-full lg:col-span-2">
                            ...
                            <div class="mb-4 lg:-mt-2">
                                ...
                                <Link href={"/"} class="inline-flex items-center gap-2 text-2xl font-bold text-gray-100 md:text-4xl" aria-label="logo">
                            ...
                            <div class="flex gap-4">
                                <Link href={'https://www.instagram.com/the.eduno/'} target="_blank" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-gray-600">
                                ...
                                {/* Twitter Link  */}
                                <Link href={'https://twitter.com/officialeduno'} target="_blank" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-gray-600">
                                    <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {/* LinkedIN Link  */}
                                <Link href={'https://www.linkedin.com/in/eduno-empower-yourself-with-eduno-830823269/'} target="_blank" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-gray-600">
                                    <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {/* GitHub Link  */}
                                <Link href={'https://github.com/officialeduno/Eduno'} target="_blank" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-gray-600">
                                    <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            ...
                            <nav class="flex flex-col gap-4">
                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">Overview</a>
                                </div>

                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">Solutions</a>
                                </div>

                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">Pricing</a>
                                </div>

                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">Customers</a>
                                </div>
                            </nav>
                        </div>
                        ...
                        <div>
                            ...
                            <nav class="flex flex-col gap-4">
                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">About</a>
                                </div>

                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">Investor Relations</a>
                                </div>

                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">Jobs</a>
                                </div>

                                <div>
                                    <a href="#" class="text-gray-400 transition duration-100 hover:text-[#a2cc4c] active:text-[#59aca7]">Press</a>
                                </div>
