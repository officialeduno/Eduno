        ...
        <div>
            <div class="bg-[#001719]">
                <div class="mx-auto max-w-screen-4xl px-4 md:px-16">
                    <header class="flex items-center justify-between py-4 md:py-4">
                        ...
                        <nav class="hidden gap-12 lg:flex">
                            ...
                            <a href="#" class="text-lg font-semibold text-white transition duration-100 hover:text-[#a2cc4c]">Course</a>
                ...
                <div ref={ref} className='sidebar flex flex-col items-center h-[100%] px-3 py-4 fixed top-0 right-0 bg-[#001719] transform transition-transform translate-x-full w-[20rem] shadow-2xl border-2 border-[#a2cc4c]'>
                    ...
                    <a href="#" class="inline-block rounded-lg px-4 py-3 mt-8 text-center text-sm font-semibold outline-none text-[#a2cc4c] transition duration-100 hover:text-white focus-visible:ring md:text-base">Sign in</a>
                    <a href="#" class="inline-block rounded-lg bg-[#a2cc4c] px-12 mt-4 py-3 text-center text-sm font-semibold text-white outline-none  transition duration-100 hover:bg-white hover:text-black focus-visible:ring active:bg-indigo-700 md:text-base">Sign up</a>
