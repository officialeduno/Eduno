        ...
        <div>
            ...
            <div class="bg-[#001719]">
                ...
                <div ref={ref} className='sidebar flex flex-col items-center h-[100%] px-3 py-4 fixed top-0 right-0 bg-[#001719] transform transition-transform translate-x-full w-[20rem] shadow-2xl border-2 border-[#a2cc4c] z-10'>
                    ...
                    <Link href={'/'} onClick={handleMenu} class="py-3 pt-4 text-lg font-semibold text-white transition duration-100 hover:text-[#a2cc4c]">Home</Link>
                    <Link href={'/features/feature'} onClick={handleMenu} class="py-3 text-lg font-semibold text-white transition duration-100 hover:text-[#a2cc4c]">Course</Link>
