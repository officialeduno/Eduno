            ...
            <div className='bg-black py-12 px-4 md:px-0 flex flex-col justify-center items-center'>
                ...
                <section class="profile-card-bg md:w-[60vw] p-6 mx-auto rounded-md shadow-md mt-12">
                    ...
                    <form>
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="linkedin">LinkedIn</label>
                                <input onChange={handleChange} value={linkedin} id="linkedin" name='linkedin' type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                            </div>

                            <div>
                                <label class="text-gray-700 dark:text-gray-200" for="github">GitHub</label>
                                <input onChange={handleChange} value={github} id="github" name='github' type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"/>
                            </div>
                        </div>
