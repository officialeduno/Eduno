                        ...
                        <div class="grid gap-8 md:grid-cols-2">
                            ...
                            <div class="space-y-4">
                                <div class="relative overflow-hidden rounded-lg bg-gray-100">
                                    <img src="../training.png" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                            ...
                            <div class="md:py-8">
                                ...
                                <div class="mb-2 md:mb-3">
                                    <h2 class="text-3xl font-bold text-white lg:text-3xl">Training and Intership 2023</h2>
                                </div>
                                {/* <!-- name - end --> */}
                                ...
                                <div class="flex gap-2.5">
                                    <a href="#" class="inline-block flex-1 rounded-lg bg-[#a2cc4c] px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-[#a2cc4c] transition duration-100 hover:bg-[#a2cc4c] focus-visible:ring active:bg-[#a2cc4c] sm:flex-none md:text-base">Buy Now</a>
...
The benefits of training in CS are vast. Firstly, it equips you with the skills and knowledge needed to succeed in a wide range of industries, including software development, cybersecurity, artificial intelligence, machine learning, and more. <br /> <br />

Secondly, training in CS can lead to a highly rewarding career with excellent job prospects and salaries. In today's digital age, computing skills are in high demand, and the need for trained professionals is only expected to grow in the future. <br /> <br />

Finally, CS training can be flexible and accessible to students from all backgrounds. Many programs offer online and in-person options, allowing students to choose the best learning format for their needs. <br /> <br />

Overall, training in CS is an excellent investment in your future career. It provides you with the knowledge and skills needed to succeed in a variety of industries, and opens up a world of opportunities. <br /> <br />
                                    </p>
