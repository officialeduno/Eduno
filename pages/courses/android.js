                        ...
                        <div class="grid gap-8 md:grid-cols-2">
                            ...
                            <div class="space-y-4">
                                <div class="relative overflow-hidden rounded-lg bg-gray-100">
                                    <img src="/courses_images/android_app_dev.png" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                            ...
                            <div class="md:py-8">
                                ...
                                <div class="mb-2 md:mb-3">
                                    <h2 class="text-3xl font-bold text-white lg:text-3xl">Android App Development</h2>
                                </div>
                                {/* <!-- name - end --> */}
                                ...
                                <div class="mb-4">
                                    <div class="flex items-end gap-2">
                                        <span class="text-xl font-bold text-white md:text-2xl">₹2,499.00</span>
                                ...
                                <div class="mt-10 md:mt-8 lg:mt-12">
                                    ...
                                    <p class="text-white">
                                        ...
                                        In addition to the certification, Eduno also provides some exciting goodies to students who perform well in the course. These can include t-shirts, mugs, and other types of gifts that are sure to make the learning experience even more enjoyable. <br /> <br />

                                        Overall, Eduno Android app development course is an excellent choice for anyone looking to expand their skills in this area. The quality of the teachers and developers, combined with the certification and gifts, make this course a fantastic investment in your future career.
                                    </p>
