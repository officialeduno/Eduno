                        ...
                        <div class="grid gap-8 md:grid-cols-2">
                            ...
                            <div class="md:py-8">
                                ...
                                <div class="flex gap-2.5">
                                    ...
                                    <Link href="https://drive.google.com/file/d/1oSQElPNcUlz0CKrwMXoQAMyqW2gXxVO0/view?usp=share_link" target='_blank' class="inline-block rounded-lg bg-gray-200 px-4 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-[#a2cc4c] transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">
                                        PDF
                                    </Link>
                                </div>
                                {/* <!-- buttons - end --> */}
