                        ...
                        <div class="grid gap-8 md:grid-cols-2">
                            ...
                            <div class="md:py-8">
                                ...
                                <div class="mb-2 md:mb-3">
                                    <h2 class="text-3xl font-bold text-white lg:text-3xl">Full Stack Web Development</h2>
                                </div>
                                {/* <!-- name - end --> */}
                                ...
                                <div class="mb-4">
                                    <div class="flex items-end gap-2">
                                        <span class="text-xl font-bold text-white md:text-2xl">₹1,499.00</span>
                                        <span class="mb-0.5 text-red-500 line-through">₹3,499.00</span>
                                    </div>
                                ...
                                <div class="mt-10 md:mt-8 lg:mt-12">
                                    ...
                                    The course is taught by experienced teachers and developers who provide hands-on instruction and real-world examples to help students apply what they've learned. The interactive learning experience ensures that students are engaged and able to progress at their own pace. <br /> <br />

                                    Upon completion of the course, students receive a certification that can be a valuable asset when applying for jobs in the industry. In addition, students who perform well in the course are rewarded with exciting goodies such as t-shirts, mugs, and other types of gifts.
                                    </p>
