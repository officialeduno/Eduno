                        ...
                        <div class="grid gap-8 md:grid-cols-2">
                            ...
                            <div class="space-y-4">
                                <div class="relative overflow-hidden rounded-lg bg-gray-100">
                                    <img src="../img/webdev.png" loading="lazy" alt="Photo by Himanshu Dewangan" class="h-full w-full object-cover object-center" />
                            ...
                            <div class="md:py-8">
                                ...
                                <div class="mb-2 md:mb-3">
                                    <h2 class="text-xl md:text-3xl font-bold text-white lg:text-3xl text-font">Full Stack Web Dev</h2>
                                </div>
                                {/* <!-- name - end --> */}
                                ...
                                <div class="mb-4">
                                    <div class="flex items-end gap-2">
                                        <span class="text-xl font-bold text-white md:text-2xl text-font">₹1,499</span>
                                        <span class="mb-0.5 text-red-500 line-through text-font">₹2,998</span>
                                    </div>
                                ...
                                <div class="flex gap-2.5">
                                    ...
                                    <Link href="https://drive.google.com/file/d/1wKDZd9E6IvGyEe1AVRFudUJNXnq3BsYI/view?usp=sharing" target='_blank' class="pdf-button inline-block rounded-lg bg-gray-200 px-4 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-[#a2cc4c] transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">
                                        PDF
                                    </Link>
                                </div>
                                {/* <!-- buttons - end --> */}
