                ...
                <div className='px-4 py-2 md:mx-24 md:px-24'>
                    ...
                    <p className='text-left text-sm md:text-lg md:pl-4 pb-2 md:pb-4'>Greeting with Eduno!</p>
                        ...
                        <p className='text-left text-lg pl-2 md:pl-8 pb-4'>
                            <span className='font-bold'>Gmail : </span><Link href={'officialeduno@gmail.com'} className="text-[#FD7014]">officialeduno@gmail.com</Link>
                            <br />
                            <span className='font-bold'>Instagram : </span><Link href={'https://www.instagram.com/the.eduno/'} className="text-[#FD7014]">the.eduno</Link>
                            <br />
                            <span className='font-bold'>LinkedIn : </span><Link href={'https://www.linkedin.com/in/eduno-empower-yourself-with-eduno-830823269/'} className="text-[#FD7014]">Eduno (Empower yourself with Eduno)</Link>
                            <br />
                            <span className='font-bold'>Twitter : </span><Link href={'https://twitter.com/officialeduno'} className="text-[#FD7014]">officialeduno</Link>
                        </p>

                        <p className='text-left text-sm md:text-lg md:pl-4 pb-2 md:pb-4'>
