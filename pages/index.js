  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" type="image/x-icon" href="eduno-with-code-background.png"></link>
      </Head>
      ...
      {/* ########## Provide a path to MNC section Start ########## */}
      ...
      {/* ########## Provide a path to MNC section End ########## */}




      {/* ########## Weekly Coding Contest Section Start ########## */}
      <section className='headerbg md:pt-28 md:pb-28 md:px-32 px-4 py-8'>
        <div className='developer-section-background flex flex-col-reverse md:flex-row justify-around items-center rounded-3xl md:px-8 '>
          ...
          {/* ########## Image of Coding contest seciton ########## */}
          <img src="img/contest.png" className='h-[30vh] md:h-[45vh]' alt="" />
        </div>
      </section>
      {/* ########## Weekly Coding contest Section End ########## */}
