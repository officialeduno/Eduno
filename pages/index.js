...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className='bg-black md:px-32 flex flex-col justify-center items-center md:py-12 md:pt-16 md:pb-0 pb-8'>
        ...
        <div className='flex flex-row gap-4 md:gap-8 md:justify-center py-4 md:py-12 overflow-x-auto scroll whitespace-nowrap scroll-smooth w-[90vw]'>
          ...
          <div>
            <a href="#" class="group relative w-72 md:w-96 h-40 md:h-80 mb-2 block overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
          ...
          <div>
            <a href="#" class="group relative mb-2 w-72 md:w-96 block h-40 md:h-80 overflow-hidden rounded-lg bg-gray-100 shadow-lg lg:mb-3">
